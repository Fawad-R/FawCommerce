...
let useParamsid=useParams();
  return (
    ...
    <nav className="navbar navbar-expand-lg bg-white shadow-lg">
        ...
        {Data.map((ele,index)=>{
        if (ele._id==useParamsid._id) {
            // console.log(ele)
            // console.log(useParamsid)
           return(  
        <div className='SingleProduct'>
            <div className='ProcuctListMainDiv1'>
                <img src={ele.img} alt="" />
            </div>
            <div className='ProcuctListMainDiv1'>
                <h3>{ele.title}</h3>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facere commodi deleniti deserunt recusandae labore iure ipsam inventore beatae cum earum adipisci, sequi consequatur, ullam nemo neque enim architecto ipsa harum. Quia vero, cupiditate eius cum aliquid sint nesciunt optio ex accusamus voluptatibus similique quisquam nemo temporibus neque, deleniti laudantium corrupti, expedita quidem incidunt cumque!</p>
                <h1>{ele.price}</h1>
                <h3>Color</h3>
                <p>Size</p>
                {/* {ele.} */}
                <select className="form-select" >
                    ...
                    <option defaultValue="1">XS</option>
                    <option defaultValue="2">S</option>
                    <option defaultValue="3">M</option>
                    <option defaultValue="4">L</option>
